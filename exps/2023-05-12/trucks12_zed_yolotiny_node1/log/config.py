...
work_dir = 'src/mmtracking/exps/2023-05-12/trucks12_zed_yolotiny_node1/log'
backbone_cfg = dict(
    type='YOLOv7',
    weights='/home/csamplawski/src/mmtracking/checkpoints/yolov7-tiny.pt',
    return_idx=1)
adapter_cfg = dict(
...
model = dict(
    ...
    backbone_cfgs=dict(
        zed_camera_left=dict(
            type='YOLOv7',
            weights=
            '/home/csamplawski/src/mmtracking/checkpoints/yolov7-tiny.pt',
            return_idx=1)),
    adapter_cfgs=dict({
        ('zed_camera_left', 'node_1'):
        dict(
